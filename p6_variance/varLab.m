...
for i = 1:8
        subplot(5,2,i)
        plot(rvMatrix(i,:)); title(['Fila ', num2str(i), ' de la matriz'])
end

subplot(5,2,9)
plot(y); title('Suma de los vectores distribuidos uniformemente.')

figure()
subplot(2,1,1)
histfit(rvMatrix(1,:)); title('Histograma de la fila 1');
subplot(2,1,2)
histfit(y); title('Histograma de la suma de las variables aleatorias')
