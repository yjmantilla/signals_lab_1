function [b_pul,c_pul,f_pul,f2_pul,p_pul,p2_pul] = fourierFun_sawtooth(Fo,k,N,N_show)
...
title(['Amplitude Spectrum of Pulse Train of ', num2str(Fo), 'Hz',' Single-sided'])
xlabel(['frequency [Hz]'])

figure()
stem(f2_pul(N+1-N_show:N+1+N_show),p2_pul(N+1-N_show:N+1+N_show))
title(['Amplitude Spectrum of Pulse Train of ', num2str(Fo), 'Hz',' Double-sided'])
xlabel(['frequency [Hz]'])

figure()
stem(f_pul(1:10),p_pul(1:10))
title(['Power Spectrum of Pulse Train of ', num2str(Fo), 'Hz',' Single-sided'])
xlabel(['frequency [Hz]'])

figure()
stem(f2_pul(N+1-N_show:N+1+N_show),p2_pul(N+1-N_show:N+1+N_show))
title(['Power Spectrum of Pulse Train of ', num2str(Fo), 'Hz',' Double-sided'])
xlabel(['frequency [Hz]'])
